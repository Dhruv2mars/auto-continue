 ...
 * Any invocation drops the marker at the end, so the marker is exactly
 * "resume in flight" — a mid-flight ack from the hook would orphan a resume
 * that is about to fail and lose the prompt for good. A stale marker (watcher
 * killed mid-send) ages out in the hook after 10 minutes.
...
import { homeDir, sessionKey } from "./lib/state.mjs";
